...
function Order({ order }) {
  ...
  if (order.status === "received") {
    bgColor = "bg-gray-100/75 dark:bg-gray-500/35";
    tagColor = "gray";
  }

  return (
    <div
      className={`grid grid-cols-[1fr_3fr_3fr_3fr] items-center justify-items-center rounded-md px-4 py-2 text-sm dark:text-gray-900 ${bgColor}`}
    >
